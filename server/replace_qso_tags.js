          ...
          if (!result.data.errorMessage && result.data.body.error === 0) {
            ...
            switch (qso.type) {
              ...
              case 'LISTEN':
                ...
                break;
              case 'POST':
                title = t('qso.createdPOST', { QRA: qso.qra });
                break;
              case 'QAP':
                title = t('qso.createdQAP', { QRA: qso.qra });
                break;
              case 'FLDDAY':
                title = t('qso.createdFLDDAY', { QRA: qso.qra });
                break;
              case 'SHARE':
                title = t('qso.sharedContent', { QRA: qso.qra });
                break;
            }
