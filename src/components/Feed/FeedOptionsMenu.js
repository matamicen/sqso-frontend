...
class FeedOptionsMenu extends React.PureComponent {
    ...
    deleteComment() {
        this
            .props
            .actions
            .doDeleteComment(this.props.idcomment, this.props.idqso, this.props.token)
    }
    deleteQso() {
        this
            .props
    ...
    render() {
        ...
        return (
            ...
            <Dropdown
                ...
                {
                    this.props.optionsCaller === 'FeedImage' && this.props.currentQRA === this.props.qso_owner && <Dropdown.Item
                        icon='delete'
                        text='Delete Photo'
                        onClick={this
                        .deleteMedia
