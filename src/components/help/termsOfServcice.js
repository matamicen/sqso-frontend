  ...
  <Fragment>
    <div className="global-container">
      ...
      <div className="site-main">
        <h3>
          <strong>SuperQSO Terms of Service</strong>
        </h3>
        <p>
          These Terms of Service (&ldquo;Terms&rdquo;) govern your access to and
          use of our services, including our various websites, SMS, APIs, email
          notifications, mobile applications,, ads, commerce services that link
          to these Terms (collectively, the &ldquo;Services&rdquo;), and any
          ...
          &ldquo;Content&rdquo;). By using the Services you agree to be bound by
          these Terms.
        </p>
        <h3>
          <strong>1. </strong>
        ...
        <p>
          ...
          with SuperQSO and are not a person barred from receiving services
          under the laws of the applicable jurisdiction. In any case, you must
          be at least 13 years old, to use the Services. If you are accepting
          ...
          bind such entity to these Terms, in which case the words
          &ldquo;you&rdquo; and &ldquo;your&rdquo; as used in these Terms shall
        ...
        <p>
          Our <a href="https://www.superqso.com/privacy">Privacy Policy</a> (
          <a href="https://www.superqso.com/privacy">
            https://www.superqso.com/privacy
          </a>
          ) describes how we handle the information you provide to us when you
          use our Services. You understand that through your use of the Services
          ...
          storage, processing and use by SuperQSO and its affiliates.
        </p>
        <h3>
          <strong>3. Content on the Services</strong>
        </h3>
        <p>
        ...
        <p>
          ...
          specific policies and the process for reporting or appealing
          violations can be found in our Help Center.
        </p>
        <p>
          If you believe that your Content has been copied in a way that
          constitutes copyright infringement, please report this by sending us
          an email to:{" "}
          <a href="mailto:legal@superqso.com">legal@superqso.com</a>
        </p>
        <h1>
          <strong>Your Rights and Grant of Rights in the Content</strong>
        </h1>
        <p>
          You retain your rights to any Content you submit, post or display on
          or through the Services. What&rsquo;s yours is yours &mdash; you own
          your Content (and your incorporated audio, photos and videos are
        ...
        <p>
          ...
          agree that this license includes the right for SuperQSO to provide,
          ...
          SuperQSO, or other companies, organizations or individuals, may be
          made with no compensation paid to you with respect to the Content that
          you submit, post, transmit or otherwise make available through the
          Services.
        </p>
        <p>
          SuperQSO has an evolving set of rules for how ecosystem partners can
        ...
        <p>
          ...
          entitled to post the material and to grant SuperQSO the license
          described above.
        </p>
        <h3>
          <strong>4. Using the Services</strong>
        </h3>
        <p>
          Please review the SuperQSO
          <a href="https://www.superqso.com/privacy"> Policies</a>, which are
          part of the User Agreement and outline what is prohibited on the
          Services. You may use the Services only in compliance with these Terms
        ...
        <p>
          In consideration for SuperQSO granting you access to and use of the
          Services, you agree that SuperQSO and its third-party providers and
          ...
          other than the interface and the instructions that we provide. You may
          not do any of the following while accessing or using the Services: (i)
          access, tamper with, or use non-public areas of the Services,
          SuperQSO&rsquo;s computer systems, or the technical delivery systems
          of SuperQSO&rsquo;s providers; (ii) probe, scan, or test the
          ...
          are provided by SuperQSO (and only pursuant to the applicable terms
          and conditions), unless you have been specifically allowed to do so in
          a separate agreement with SuperQSO (NOTE: crawling the Services is
          ...
          consent of SuperQSO is expressly prohibited); (iv) forge any TCP/IP
          ...
          undue burden on the Services. We also reserve the right to access,
          ...
          process or governmental request, (ii) enforce the Terms, including
          ...
          safety of SuperQSO, its users and the public. SuperQSO does not
        ...
        <p>
          SuperQSO gives you a personal, worldwide, royalty-free, non-assignable
          ...
          use and enjoy the benefit of the Services as provided by SuperQSO, in
          the manner permitted by these Terms.
        </p>
        <p>
          The Services are protected by copyright, trademark, and other laws of
          both the United States and foreign countries. Nothing in the Terms
          gives you a right to use the SuperQSO name or any of the SuperQSO
          ...
          of SuperQSO and its licensors. Any feedback, comments, or suggestions
          you may provide regarding SuperQSO, or the Services is entirely
        ...
        <p>
          You may end your legal agreement with SuperQSO at any time by
        ...
        <p>
          ...
          violated these Terms or the SuperQSO
          <a href="https://www.superqso.com/terms"> Policies</a> (ii) you create
          risk or possible legal exposure for us; (iii) your account should be
          removed due to prolonged inactivity; or (iv) our provision of the
        ...
        <h3>
          <strong>5. Disclaimers and Limitations of Liability</strong>
        </h3>
        <h1>
          <strong>The Services are Available "AS-IS"</strong>
        </h1>
        <p>
          ...
          &ldquo;SuperQSO Entities&rdquo; refers to SuperQSO, its parents,
          ...
          SUPERQSO ENTITIES DISCLAIM ALL WARRANTIES AND CONDITIONS, WHETHER
          EXPRESS OR IMPLIED, OF MERCHANTABILITY, FITNESS FOR A PARTICULAR
          PURPOSE, OR NON-INFRINGEMENT. The SuperQSO Entities make no warranty
          ...
          whether oral or written, obtained from the SuperQSO Entities or
        ...
        <p>
          TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE SUPERQSO
          ...
          THE SUPERQSO ENTITIES EXCEED THE GREATER OF ONE HUNDRED U.S. DOLLARS
          (U.S. $100.00) OR THE AMOUNT YOU PAID SUPERQSO, IF ANY, IN THE PAST
          ...
          OTHERWISE, AND WHETHER OR NOT THE SUPERQSO ENTITIES HAVE BEEN INFORMED
        ...
        <p>
          ...
          always be at{" "}
          <a href="https://www.superqso.com/terms">superqso.com/terms</a>, will
          ...
          to the email associated with your account. By continuing to access or
          use the Services after those revisions become effective, you agree to
          be bound by the revised Terms.
        </p>
        <p>
          The laws of Buenos Aires, Argentina, excluding its choice of law
          provisions, will govern these Terms and any dispute that arises
          between you and SuperQSO. All disputes related to these Terms or the
          Services will be brought solely in the federal or state courts located
          in Buenos Aires, CABA, Argentina, and you consent to personal
