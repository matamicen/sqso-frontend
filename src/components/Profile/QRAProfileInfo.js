...
class QRAProfileInfo extends React.Component {
    ...
    handleOnSaveInfo = (e) => {
        this
            .props
            .actions
            .doSaveUserInfo(this.props.token, this.state.qra)
        this.close();
    };
    changeHandler = event => {
    ...
    render() {
        ...
        return (
            <Fragment>
                <Segment raised>
                    <Form size='mini'>
                        {this.props.isAuthenticated && this.props.currentQRA === this.props.qraInfo.qra && <div
                            style={{
                            float: 'right'
                        }}>
                            ...
                            <Dropdown
                                ...
                                pointing="right">
                                <Dropdown.Menu>
                                    {!edit && < Dropdown.Item text = 'Edit Info' onClick = {
                                        this.open
                                    } />}
                                    {edit && < Dropdown.Item text = 'Save Info' onClick = {
                                        this.handleOnSaveInfo
                                    } />}
                                </Dropdown.Menu>
                            </Dropdown>
                        </div>
