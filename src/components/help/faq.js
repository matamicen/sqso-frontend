    ...
    <div className="global-container">
      ...
      <div className="site-main"  onContextMenu={(e)=> e.preventDefault()}>
        ...
        <video  width="100%"  controls controlsList="nodownload">
          <source
            src="https://d1v72vqgluf2qt.cloudfront.net/faq/tutorialCompleto_j.mp4"
            type="video/mp4"
        ...
        <video width="100%" controls controlsList="nodownload">
          <source
            src="https://d1v72vqgluf2qt.cloudfront.net/faq/PostQSO_alta_j.mp4"
            type="video/mp4"
        ...
        <video width="100%" controls controlsList="nodownload">
          <source
            src="https://d1v72vqgluf2qt.cloudfront.net/faq/Post+de+una+escucha_j.mp4"
            type="video/mp4"
            controlsList="nodownload"
          />
          Your browser does not support the video tag.
        ...
        <video width="100%" controls controlsList="nodownload">
          <source
            src="https://d1v72vqgluf2qt.cloudfront.net/faq/PostANY_j.mp4"
            type="video/mp4"
            controlsList="nodownload"
          />
          Your browser does not support the video tag.
        ...
        <video width="100%" controls controlsList="nodownload">
          <source
            src="https://d1v72vqgluf2qt.cloudfront.net/faq/Seguir+a+un+colega_j.mp4"
            type="video/mp4"
            controlsList="nodownload"
          />
          Your browser does not support the video tag.
        ...
        <video width="100%" controls controlsList="nodownload">
          <source
            src="https://d1v72vqgluf2qt.cloudfront.net/faq/Leer+notificaciones_j.mp4"
            type="video/mp4"
            controlsList="nodownload"
          />
          Your browser does not support the video tag.
        ...
        <video width="100%" controls controlsList="nodownload">
          <source
            src="https://d1v72vqgluf2qt.cloudfront.net/faq/Imprimir+tarjeta+QSL_j.mp4"
            type="video/mp4"
            controlsList="nodownload"
          />
          Your browser does not support the video tag.
        ...
        <video width="100%" controls controlsList="nodownload">
          <source
            src="https://d1v72vqgluf2qt.cloudfront.net/faq/Escanear+c%C3%B3digo+QR+de+tarjeta+QSL_j.mp4"
            type="video/mp4"
            controlsList="nodownload"
          />
          Your browser does not support the video tag.
        ...
        <video width="100%" controls controlsList="nodownload">
          <source
            src="https://d1v72vqgluf2qt.cloudfront.net/faq/Compartir+en+redes+sociales+desde+la+APP_j.mp4"
            type="video/mp4"
            controlsList="nodownload"
          />
          Your browser does not support the video tag.
        ...
        <video width="100%" controls controlsList="nodownload">
          <source
            src="https://d1v72vqgluf2qt.cloudfront.net/faq/Compartir+en+redes+sociales+desde+la+Web_j.mp4"
            type="video/mp4"
            controlsList="nodownload"
          />
          Your browser does not support the video tag.
        ...
        <video width="100%" controls controlsList="nodownload">
          <source
            src="https://d1v72vqgluf2qt.cloudfront.net/faq/Comentar%2C+Like+y+Repostear_j.mp4"
            type="video/mp4"
            controlsList="nodownload"
          />
          Your browser does not support the video tag.
