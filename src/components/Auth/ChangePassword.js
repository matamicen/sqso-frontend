...
class ChangePassword extends React.Component {
    ...
    constructor(props) {
        ...
        this.handleChangePasswordButton = this
                ...
                <div className='changepassword-main'>
                    ...
                    <Segment raised>
                        ...
                        <Form onSubmit={() => this.handleChangePasswordButton()}>
                            ...
                            {this.state.changePasswordError && <Message negative content={this.state.changePasswordError}/>}
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps, null, {pure: false})(ChangePassword));
