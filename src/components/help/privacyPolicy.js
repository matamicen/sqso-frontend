    ...
    <div className="global-container">
      ...
      <div className="site-main">
        ...
        <p dir="ltr">
          ...
          (&ldquo;Services&rdquo;). It also has information about how we store,
        ...
        <p dir="ltr">
          ...
          SuperQSO, we collect information from your interactions with our
          Services. Some of this information, you actively tell us (such as your
          email address, which we use to track your account or communicate with
          you). Other information, we collect based on actions you take while
          using SuperQSO, such as what pages you view (including how much of a
          given page and for how long) and your use of product features (like
          follows, likes, QsoScans and QsoLinks). This information includes
          records of those interactions, your Internet Protocol address,
          information about your device (such as device or browser type), and
          referral information (how you got to a particular page).
        </p>
        <p dir="ltr">We use this information to:</p>
        <ul>
          <li dir="ltr">
            <p dir="ltr">
          ...
          <li dir="ltr">
            <p dir="ltr">fight spam and other forms of abuse</p>
          </li>
          <li dir="ltr">
            <p dir="ltr">
        ...
        <p dir="ltr">
          ...
          to you. We won&rsquo;t sell information about you to a third-party.
        </p>
        <p dir="ltr">
          ...
          or pseudonymization; (4) when we have a good faith belief it is
          required by law, such as pursuant to a subpoena or other legal
          process; (5) when we have a good faith belief that doing so will help
          prevent imminent harm to someone.
        </p>
        <p dir="ltr">
          If we are going to share your information in response to legal
          process, we&rsquo;ll give you notice so you can challenge it (for
          example by seeking court intervention), unless we&rsquo;re prohibited
        ...
        <p dir="ltr">
          ...
          interactions (such as photos, audios, likes or comments), and post
          pages (such as QSOs, Listen, Post and the audios &amp; photos), such
          that people may find these pages when searching against your name on
        ...
        <p dir="ltr">
          Some of the content that you see displayed on SuperQSO is not hosted
          by SuperQSO. These &ldquo;embeds&rdquo; are hosted by a third-party
          and embedded in a SuperQSO page, so that it appears to be part of that
          ...
          Scribd documents that appear within a SuperQSO post. These files send
          data to the hosted site just as if you were visiting that site
          directly (for example, when you load a SuperQSO post page with a
          YouTube video embedded in it, that video appears because of a pointer
          to files hosted by YouTube, and in turn YouTube receives data about
          your activity, such as your IP address and how much of the video you
          watch).
        </p>
        <p dir="ltr">
          SuperQSO doesn&rsquo;t control what data third parties collect in
          cases like this, or what they ultimately do with it. So, third-party
          embeds on SuperQSO are not covered by this Privacy Policy. They are
          covered by the privacy policy of the third-party service (so, when you
          watch a YouTube video embedded in a SuperQSO post, the use of data
          about your interactions with the video would be covered by
          YouTube&rsquo;s privacy policy).
        </p>
        <p dir="ltr">
          Some embeds may ask you for personal information, such as submitting
          your email address, through a form linked to from a SuperQSO post. We
          do our best to keep bad actors off of SuperQSO. However, if you choose
          to submit your information to a third party this way, we don&rsquo;t
          know what they may do with it. As explained above, their actions are
          not covered by this Privacy Policy. So, please be careful when you see
          embedded forms on SuperQSO asking for your email address or any other
          ...
          suggest that you do not submit your email address or other personal
          information to any third-party through an embedded form.
        </p>
        <p dir="ltr">
          When posting on SuperQSO, you may not embed a form that allows
          submission of personal information by users. You must link offsite to
          a page that allows such submissions by users, and that page&rsquo;s
          appearance must be distinct enough from SuperQSO to ensure it does not
          cause confusion among users over to whom they are submitting personal
        ...
        <p dir="ltr">
          ...
          you return to our Services. We use them in various ways, for example
          to log you in, remember your preferences (such as default language),
          evaluate email effectiveness, allow our paywall and meter to function,
          and personalize content and other services. Without cookies, our
          metered paywall would not work, so they are necessary to
          SuperQSO&rsquo;s basic functionality.
        </p>
        <p dir="ltr">
          SuperQSO saves data about the URLs you Save to SuperQSO , but we do
          not otherwise track your visits or activities off SuperQSO Services.
          We track your interactions within the SuperQSO Services (which
          encompasses SuperQSO.com, custom domains hosted by SuperQSO, and your
        ...
        <p dir="ltr">
          ...
          may maintain residual copies for a brief time period (generally
          several weeks). But, if you delete your account, your information and
          content will be unrecoverable after that time. SuperQSO may preserve
        ...
        <p dir="ltr">
          We won&rsquo;t email you to ask for your password or other account
          information. If you receive such an email, please forward it to us at{" "}
          <a
            href="mailto:legal@superqso.com"
            target="_blank"
            rel="noopener noreferrer"
          >
            &nbsp;legal@superqso.com&nbsp;
